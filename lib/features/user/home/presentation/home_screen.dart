...
// import 'widgets/UrlInputBottomSheet.dart';
//
...
//             ),
//             builder: (context) => const UrlInputBottomSheet(),
//           );
//         },
...
class _HomeScreenState extends ConsumerState<HomeScreen> {
  ...
  void initState() {
    ...
    _audioPlayer.processingStateStream.listen((state) async {
      if (state == ProcessingState.completed && recordedFilePath != null) {
        ...
        child: Center(
          child: Column(
            ...
            children: [
                ...
                child: Stack(
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        shape: BoxShape.circle,
                        border: Border.all(color: ringColor, width: 10),
                      ),
                    ),
                    Container(
                      width: 230,
                    ...
                    Positioned(
                      bottom: 50,
                      child: Text(
                        _isRecording || isRecorded ? "${recordingTime}s" : "",
              ...
              if (isRecorded && recordedFilePath != null&&!_isRecording)
                Row(
                  ...
                  children: [
                    ...
                    Text(_isPlaying ? "Playing..." : "Play Recording"),
                  ],
                ),
              SizedBox(height: 20),
              if (_result.isNotEmpty)
